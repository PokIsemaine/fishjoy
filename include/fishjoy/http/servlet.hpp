 ...
 * @brief Servlet封装
     ...
     * @return 是否处理成功
       */
      virtual int32_t handle(fishjoy::http::HttpRequest::ptr request
                             , fishjoy::http::HttpResponse::ptr response
                             , fishjoy::http::HttpSession::ptr session) = 0;
 ...
 * @brief 函数式Servlet
    ...
    class FunctionServlet : public Servlet {
     public:
      ...
      /// 函数回调类型定义
      typedef std::function<int32_t (fishjoy::http::HttpRequest::ptr request
                                    , fishjoy::http::HttpResponse::ptr response
                                    , fishjoy::http::HttpSession::ptr session)> callback;
     ...
     * @param[in] cb 回调函数
      ...
      virtual int32_t handle(fishjoy::http::HttpRequest::ptr request
                             , fishjoy::http::HttpResponse::ptr response
                             , fishjoy::http::HttpSession::ptr session) override;
     private:
      /// 回调函数
      callback m_cb;
    };
 ...
 * @brief Servlet分发器
     ...
     * @param[in] cb FunctionServlet回调函数
      ...
      /**
     * @brief 添加模糊匹配servlet
     * @param[in] uri uri 模糊匹配 /fishjoy_*
     * @param[in] slt servlet
       */
