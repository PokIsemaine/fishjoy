...
#ifndef FISHJOY_ADDRESS_HPP
#define FISHJOY_ADDRESS_HPP
 ...
 * @brief 网络地址的基类,抽象类
  ...
  class Address {
   public:
     ...
     * @param[in] host 域名,服务器名等.举例: www.fishjoy.top[:80] (方括号为可选内容)
 ...
 * @brief IP地址的基类
  ...
  class IPAddress : public Address {
   public:
     ...
     * @param[in] address 域名,IP,服务器名等.举例: www.fishjoy.top
     * @param[in] port 端口号
